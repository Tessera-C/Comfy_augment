...
class SaveImage:
    ...
    def INPUT_TYPES(s):
        return {
            ...
            "hidden": {
                "prompt": "PROMPT", "extra_pnginfo": "EXTRA_PNGINFO", "use_counter" : (
                "BOOLEAN",
    ...
    def save_images(self, images, filename_prefix="ComfyUI", prompt=None, extra_pnginfo=None, use_counter=True):
